...
namespace IKVM.AWT.WinForms
{
    ...
    {
        internal readonly ToolStripMenuItem menu = new();
        ...
        public void addItem(java.awt.MenuItem item)
        {
            ...
            {
                NetToolkit.Invoke(delegate { menu.DropDownItems.Add(menuItemPeer.menuitem); });
            }
            else if (item.getPeer() is NetMenuPeer menuPeer)
            {
                NetToolkit.Invoke(delegate { menu.DropDownItems.Add(menuPeer.menu); });
            }
        }
