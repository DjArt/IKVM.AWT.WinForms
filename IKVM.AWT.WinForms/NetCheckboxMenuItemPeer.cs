    ...
    sealed class NetCheckboxMenuItemPeer : NetMenuItemPeer, java.awt.peer.CheckboxMenuItemPeer
    {
        ...
        protected override void OnClick(object sender, EventArgs e)
        {
            ...
            sun.awt.SunToolkit.executeOnEventHandlerThread(target, Delegates.toRunnable(delegate
            {
                ...
                sun.awt.SunToolkit.postEvent(sun.awt.SunToolkit.targetToAppContext(target), new java.awt.@event.ItemEvent(target, java.awt.@event.ItemEvent.ITEM_STATE_CHANGED,
